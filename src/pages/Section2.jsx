    ...
    <div className=''>
        <div className='grid grid-cols-1 md:grid-cols-2 mx-5 md:mx-24 gap-4 my-10 w-auto'>
            ...
            <div className="text-start ">
                <h1 className='text-2xl mt-[-8px] font-bold'>New to photography? Let us help!</h1>
                ...
                <div className='flex my-2 hover:bg-slate-300  w-64 group p-1'>
                    ...
                    <input placeholder='Search Guides' className=' placeholder:text-sm placeholder:text-black border-0 border-white outline-0 group-hover:bg-slate-300 bg-[#FCF6F6]' type="text" name="" id="" />
                </div>
